...
class TestLowRiskFrequency(TransactionCase):
    ...
    def setUp(self):
        ...
        frequency_task.data_ref.frequency = frequencies.ONE_WEEK

        self.test_utils.complete_frequency()

        self.spell_activity = \
            self.env['nh.activity'].browse(self.test_utils.spell_activity_id)
        self.data_model = 'nh.clinical.notification.frequency_agreed'
        self.act_summary = 'Confirm \'{0}\' frequency agreed with Medical Team'
        self.frequency_label = frequencies.get_label_for_minutes(60)
        # Doesn't like single quotes in act_summary.
        self.act_summary_xpath = 'frequency agreed with Medical Team'
    ...
    def test_frequency_agreed_task_create(self):
        """
    ...
    def test_frequency_agreed_task_after_pme(self):
        """
    ...
    def test_frequency_agreed_task_after_transfer_out(self):
        """
    ...
    def test_frequency_agreed_task_after_transfer_in(self):
        """
    ...
    def test_frequency_agreed_task_after_partial(self):
        """
    ...
    def test_frequency_agreed_task_after_refusal(self):
        """
    ...
    def test_frequency_agreed_task_on_workload_view(self):
        """
    ...
    def test_frequency_agreed_task_on_overdue_tasks_view(self):
        """
    ...
    def test_frequency_agreed_task_on_report_in_progress(self):
        """
        ...
        task_status = self.test_utils.get_report_triggered_action_status(
            self.act_summary_xpath)
        self.assertEqual(task_status, 'Task still in progress')

    def test_frequency_agreed_agreed_task_on_report_completed(self):
        """
        Test that the Review Frequency task is in the report for
        the patient when it's been completed
        """
        self.test_utils.complete_frequency_agreed()
        task_status = self.test_utils.get_report_triggered_action_status(
            self.act_summary_xpath)
        self.assertTrue('Date: ' in task_status)

    def test_frequency_agreed_task_after_shift_change(self):
        """
    ...
    def test_inform_medical_team_task_created_on_complete(self):
        """
