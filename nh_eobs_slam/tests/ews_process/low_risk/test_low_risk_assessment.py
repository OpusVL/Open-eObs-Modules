...
class TestLowRiskAssessment(TransactionCase):
    """
    Test that the Inform Shift Coordinator task is generated for the Nurse on
    a High Risk EWS observation being completed
    """

    def setUp(self):
        super(TestLowRiskAssessment, self).setUp()
        ...
        self.data_model = 'nh.clinical.notification.assessment'
        self.act_summary = 'Assess Patient'
    ...
    def test_assess_patient_task_create(self):
        """
        Test that the Assess Patient task is created after completing
        a high risk EWS
        """
        self.check_number_of_activities(1)

    def test_assess_patient_task_after_pme(self):
        """
        Test that the Assess Patient task is no longer available
        after PME
        """
        self.check_number_of_activities(1)
    ...
    def test_assess_patient_task_after_transfer_out(self):
        """
    ...
    def test_assess_patient_task_after_transfer_in(self):
        """
    ...
    def test_assess_patient_task_after_partial(self):
        """
    ...
    def test_assess_patient_task_after_refusal(self):
        """
    ...
    def test_assess_patient_task_on_workload_view(self):
        """
        Test that Assess Patient task is visible in the workload view
        on the desktop
        """
    ...
    def test_assess_patient_task_on_overdue_tasks_view(self):
        """
        Test that the Assess Patient task is in the overdue tasks
    ...
    def test_assess_patient_task_on_report_in_progress(self):
        """
        Test that the Assess patient task is in the report for the
    ...
    def test_assess_patient_task_on_report_completed(self):
        """
        Test that the Assess Patient task is in the report for the
    ...
    def test_assess_patient_task_after_shift_change(self):
        """
        Test that the Assess Patient task is in task list of new
    ...
    def test_inform_shift_coordinator_task_created_on_complete(self):
        """
        Test that the Inform Shift Coordinator task is created when the
        Assess Patient task is completed
        """
        activity_model = self.env['nh.activity']
    ...
    def test_mobile_api_complete_response(self):
        """
        Test the response from the Mobile API when completing the Assess
